...
For example, consider the below code from Bootstrap's documentation for defining a [modal](https://getbootstrap.com/docs/5.2/components/modal/) and a button to open it:
